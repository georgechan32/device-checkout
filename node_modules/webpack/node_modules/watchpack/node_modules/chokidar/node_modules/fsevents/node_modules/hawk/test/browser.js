...
describe('Browser', function () {
    ...
    describe('bewit()', function () {
        ...
        it('returns a valid bewit value (explicit HTTP port)', function (done) {
            ...
            var bewit = Browser.client.bewit('http://example.com:9030/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
    ...
    it('generates a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' }).field;
    ...
    it('generates a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var reqHeader = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', payload: payload, contentType: req.headers['content-type'] });
    ...
    it('generates a header then successfully parse it (time offset)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', localtimeOffsetMsec: 100000 }).field;
            expect(req.authorization).to.exist();
    ...
    it('generates a header with stale ts and successfully authenticate on second call', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var header = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' });
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts2) {
                ...
                req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials2, ext: 'some-app-data' }).field;
                expect(req.authorization).to.exist();
    ...
    it('generates a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, payload: 'hola!', ext: 'some-app-data' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://example.com:9030/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
        ...
        describe('message()', function () {
            ...
            it('generates an authorization then successfully parse it', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials1) {
                    ...
                    var auth = Browser.client.message('example.com', 9030, 'some message', { credentials: credentials1 });
                    expect(auth).to.exist();

                    Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, credentialsFunc, {}, function (err, credentials2) {
            ...
            it('generates an authorization using custom nonce/timestamp', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 9030, 'some message', { credentials: credentials, nonce: 'abc123', timestamp: 1398536270957 });
                    expect(auth).to.exist();
            ...
            it('errors on missing host', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message(null, 9030, 'some message', { credentials: credentials });
            ...
            it('errors on invalid host', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message(5, 9030, 'some message', { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on missing message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 9030, undefined, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on null message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 9030, null, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on invalid message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('example.com', 9030, 5, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on missing credentials', function (done) {
                ...
                var auth = Browser.client.message('example.com', 9030, 'some message', {});
                expect(auth).to.not.exist();
                done();
            });
            ...
            it('errors on invalid credentials (id)', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    delete creds.id;
                    var auth = Browser.client.message('example.com', 9030, 'some message', { credentials: creds });
                    expect(auth).to.not.exist();
                    done();
                });
            });
