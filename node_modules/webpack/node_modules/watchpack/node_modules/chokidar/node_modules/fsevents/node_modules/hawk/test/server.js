...
describe('Server', function () {
    ...
    describe('authenticate()', function () {
        ...
        it('parses a valid authentication header (host port override)', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { host: 'example.com', port: 9030, localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
    ...
    describe('authenticateMessage()', function () {
        ...
        it('errors on invalid authorization (ts)', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('example.com', 9030, 'some message', { credentials: credentials1 });
                delete auth.ts;
        ...
        it('errors with credentials', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, function (id, callback) {
        ...
        it('errors on nonce collision', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('example.com', 9030, 'some message', { credentials: credentials1 });
                Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, credentialsFunc, {
        ...
        it('should fail authorization on mismatching host', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('example1.com', 9030, 'some message', auth, credentialsFunc, {}, function (err, credentials2) {
        ...
        it('should fail authorization on stale timestamp', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, credentialsFunc, { localtimeOffsetMsec: 100000 }, function (err, credentials2) {
        ...
        it('overrides timestampSkewSec', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('example.com', 9030, 'some message', { credentials: credentials1, localtimeOffsetMsec: 100000 });
                expect(auth).to.exist();

                Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, credentialsFunc, { timestampSkewSec: 500 }, function (err, credentials2) {
        ...
        it('should fail authorization on bad hash', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('example.com', 9030, 'some message1', auth, credentialsFunc, {}, function (err, credentials2) {
        ...
        it('should fail authorization on credentials error', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('example.com', 9030, 'some message', auth, errFunc, {}, function (err, credentials2) {
        ...
        it('should fail on missing host', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials) {
                ...
                var auth = Hawk.client.message(null, 9030, 'some message', { credentials: credentials });
        ...
        it('should fail on missing credentials', function (done) {
            ...
            var auth = Hawk.client.message('example.com', 9030, 'some message', {});
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('should fail on invalid algorithm', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials) {
                ...
                var auth = Hawk.client.message('example.com', 9030, 'some message', { credentials: creds });
                expect(auth).to.not.exist();
                done();
            });
        });
